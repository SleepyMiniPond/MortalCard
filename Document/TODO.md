...
- **現況**：
  ...
  - `Played`、`EffectPlayed`、`Preserved`、`Discarded`、`EffectDiscarded` 仍待後續工作包接入正式 Runtime 入口。
...
- **狀態**：🔄 工作包 4 `EffectDrawed` 已完成實作與完整驗證，待使用者確認；確認後下一步為工作包 5 `Played`／`EffectPlayed`
